...
//  hemocell.setSystemPeriodicity(0, true);
  ...
  pcout << "z1= " << (hemocell.lattice->getBoundingBox().z1)/2 - rPipe << endl;

  Box3D preinletBox(0,20,0,hemocell.lattice->getBoundingBox().y1,(hemocell.lattice->getBoundingBox().z1/2)-(rPipe+1),(hemocell.lattice->getBoundingBox().z1/2)+(rPipe+1));
