#!/bin/bash
#SBATCH -t 5-00:00:00   #Ten minutes, adjust to need
#SBATCH -n 24         #number of needed processors, automatically calculate number of needed nodes
...
source ~/work/hemocell/scripts/cartesius_env.sh
#Place the actual command here
#Dont forget to place this file in the directory you want to run from
mpirun -n 24 ./pipeflow tmp/checkpoint.xml #dont forget to adjust -n !!
