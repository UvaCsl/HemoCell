...
#SBATCH -n 192       #number of needed processors, automatically calculate number of needed nodes
...
mpirun -n 192 ./microcontraction config.xml #dont forget to adjust -n !!
