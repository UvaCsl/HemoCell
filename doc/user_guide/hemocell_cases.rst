...
pipe flow problems. The single cell problems, such as a single
...
A next step might then be the analysis of single cell's deformation in a pipe
flow conditions, which is illustrated by the :ref:`parachuting
<cases/parachuting:A parachuting cell>` example followed by cell-cell
interactions and  (near)collisions between multiple cells
