...
//void orderedPositionMultipleCellField3DWithSpace(HemoCellField & cellFields, Box3D ToDelete);
...
{
public:
    OrderedPositionMultipleCellField3DWithSpace (std::vector<HemoCellField* > & cellFields_, Box3D ToDelete_):
   //  OrderedPositionMultipleCellField3DWithSpace (HemoCellField & cellField_, Box3D ToDelete_):
