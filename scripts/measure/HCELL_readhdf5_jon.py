...
class FLUID(object):
    def __init__(self, dt=None,dx=None,dxdydz=None,iteration=None,numberofcells=None,processorId=None,relativeposition=None,subdomainsize=None,position=None,velocity=None,boundary=None):
        self.dt = dt 
        self.dx = dx
        self.dxdydz = dxdydz
...
def core_read_processor(f,r,p,ct3,full,half,t,datapath,fluidname,rbcname,pltname,ct3name,n):
    ...
    return(fdt,fdx,fdxdydz,fiter,fNpart,fprocid,frelpos,fsubdomsize,fpos,fvel,
        ...
        ct3dt,ct3dx,ct3iter,ct3Npart,ct3Nproc,ct3Ntri,ct3procid,ct3Farea,ct3Fbend,ct3Flink,ct3Ftotal,ct3Fvisc,ct3Fvol,ct3triangles,ct3pos,ct3cid,fb)
...
def open_hdf5_files(f=True,r=True,p=True,ct3=True,full=False,half=False,read_procs=1,timesteps=range(0,10000000,5000000),datapath=".",fluidname="Fluid",rbcname="RBC",pltname="PLT",ct3name="RBC_stiff",nprocs=1):
    ...
    for t in timesteps:
        ...
        if f:
            fluid.append(FLUID(fdt,fdx,fdxdydz,fiter,fNpart,fprocid,frelpos,fsubdomsize,fpos,fvel,fb))
        if r:
