...
def open_hdf5_files(f=True,r=True,p=True,ct3=True,full=False,half=False,read_procs=1,begin=0,end=0,timestep=100000,datapath=".",fluidname="Fluid",rbcname="RBC",pltname="PLT",ct3name="RBC_stiff",nprocs=1):
