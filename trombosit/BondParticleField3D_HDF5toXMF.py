...
def createH5TopologyAndGeometryCell(xmlInt=XMLIndentation()):
	...
	---------
		...
		Fields are:
			...
			dx (not used)
	"""
	h5TopologyAndGeometry  = xmlInt.cur() + '<Topology TopologyType="Polyline" NumberOfElements="%(numberOfParticles)d">\n'
	h5TopologyAndGeometry += xmlInt.inc() + ' <DataItem Dimensions="%(numberOfParticles)d 2" NumberType="Int" Precision="8" Format="HDF">\n'
	h5TopologyAndGeometry += xmlInt.cur() + '%(pathToHDF5)s:/connections\n'
	...
	h5TopologyAndGeometry += xmlInt.inc() + ' <DataItem Dimensions="%(numberOfVertices)d 3" NumberType="Float" Precision="4" Format="HDF">\n'
...
def createH5AttibuteCell(xmlInt=XMLIndentation()):
	...
	h5Attribute += xmlInt.inc() + '<DataItem Dimensions="%(numberOfVertices)d %(rankString)s" Format="HDF">\n'
