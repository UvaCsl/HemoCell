...
//    =======================  Create Platelet
        ...
        TriangleBoundary3D<T> PLTCells = constructMeshElement(6, pltRadius, cellNumTriangles/2, dx, cellPath, eulerAngles, aspectRatio);
        ...
        cellFields.push_back(new CellField3D<T, DESCRIPTOR>(lattice, pltMeshElement, 0.01, cellModels[cellModels.size()-1], ibmKernel, "PLT"));
