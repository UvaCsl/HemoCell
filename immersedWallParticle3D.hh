...
/* *************** class ImmersedWallParticle3D ************************************ */

template<typename T, template<typename U> class Descriptor>
int ImmersedWallParticle3D<T,Descriptor>::id =
        meta::registerImmersedWallParticle3D<T,Descriptor,ImmersedWallParticle3D<T,Descriptor> >("ImmersedWall");
...
template<typename T, template<typename U> class Descriptor>
int ImmersedWallParticle3D<T,Descriptor>::getId() const {
    return id;
}

template<typename T, template<typename U> class Descriptor>
void ImmersedWallParticle3D<T,Descriptor>::reset(Array<T,3> const& position_)
{
...
template<typename T, template<typename U> class Descriptor>
void ImmersedWallParticle3D<T,Descriptor>::serialize(HierarchicSerializer& serializer) const
{
...
template<typename T, template<typename U> class Descriptor>
void ImmersedWallParticle3D<T,Descriptor>::unserialize(HierarchicUnserializer& unserializer)
{
...
template<typename T, template<typename U> class Descriptor>
ImmersedWallParticle3D<T,Descriptor>* ImmersedWallParticle3D<T,Descriptor>::clone() const {
    return new ImmersedWallParticle3D<T,Descriptor>(*this);
}
...
template<typename T, template<typename U> class Descriptor>
bool ImmersedWallParticle3D<T,Descriptor>::getVector(plint whichVector, Array<T,3>& vector) const {
    if (whichVector==0) {
        vector = get_v();
        return true;
